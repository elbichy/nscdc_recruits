					...
					<div class="importRecords">
						...
						<div class="card green darken-1"  style="margin-top:0;">
							<div class="card-content">
								...
								<form style="margin-top: 15px;padding: 10px;" action="{{ route('store_imported_personnel') }}" method="post" enctype="multipart/form-data" id="importData" class="row">
									@csrf
						...
						<div class="card green darken-1"  style="margin-top:0;">
							<div class="card-content">
								...
								<form style="margin-top: 15px;padding: 10px;" action="{{ route('store_imported_variation') }}" method="post" enctype="multipart/form-data" id="importData" class="row">
									@csrf
									<input type="file" name="import_file" class="left"/>
									<button class="importBtn btn waves-effect waves-light green darken-2 right">Import File</button>
								</form>
