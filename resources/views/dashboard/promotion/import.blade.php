@extends('administration.layouts.app', ['title' => 'Import New Records'])
					...
					<div class="importRecords">
						...
						<div class="card green darken-1"  style="margin-top:0;">
							<div class="card-content">
								<h5 class="card-title white-text">Import promotion records from excel</h5>
								<form style="margin-top: 15px;padding: 10px;" action="{{ route('store_imported_promotion') }}" method="post" enctype="multipart/form-data" id="importData" class="row">
									@csrf
									<input type="file" name="import_file" class="left"/>
									<select id="year" name="year" class=" browser-default left" required>
