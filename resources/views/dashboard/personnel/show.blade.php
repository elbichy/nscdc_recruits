						...
						<div class="sideColumn">
							<div class="profilePic">
								...
								@else
									...
									@if(env("FILESYSTEM_DRIVER") == 'do_spaces')
									{{-- DO WAY --}}
									<img src="{{ $personnel->passport }}" alt="Profile Pic" width="100%">
									@else
									{{-- LOCAL WAY --}}
								...
								@foreach($personnel->documents as $document)
									<ul>
										...
										<li>
											@if(env("FILESYSTEM_DRIVER") == 'do_spaces')
											{{-- DO WAY --}}
											<a href="{{ $document->file }}" data-lightbox="documents"  data-title="{{ strtoupper($document->title) }}">
												<img src="{{ $document->file }}" width="80px">
											</a>
											@else
											{{-- LOCAL WAY --}}
