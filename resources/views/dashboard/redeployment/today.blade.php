            ...
            <div class="sectionWrap">
                ...
                <div class="sectionTableWrap z-depth-1">
                    <div class="row topMenuWrap">
                        ...
                        <button id="cloudUpload" class="cloudUpload btn btn-small orange darken-2 white-text"><i class="material-icons right">cloud_upload</i> push to cloud</button>
                        <button id="cloudDownload" class="cloudDownload btn btn-small green darken-2 white-text"><i class="material-icons right">cloud_download</i> pull from cloud</button>
