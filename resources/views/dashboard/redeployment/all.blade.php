            ...
            <div class="sectionWrap">
                ...
                <div class="sectionTableWrap z-depth-1">
                    <div class="row topMenuWrap">
                        ...
                        <button id="cloudUpload" class="cloudUpload btn btn-small orange darken-2 white-text">
                            <i class="material-icons right">cloud_upload</i>
                            <p>push to cloud</p>
                        </button>
                        <button id="cloudDownload" class="cloudDownload btn btn-small green darken-2 white-text">
