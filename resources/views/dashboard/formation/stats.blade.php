		...
		<div class="content-container white">
			<div class="sectionWrap">
							...
							<div class="card gradient-45deg-light-blue-cyan gradient-shadow min-height-100 white-text">
								<div class="padding-4">
									...
									<div class="col s8 m8 right-align">
										...
										<p class="no-margin">Dept, Units, Divs</p>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card gradient-45deg-amber-amber gradient-shadow min-height-100 white-text">
								<div class="padding-4">
									...
									<div class="col s8 m8 right-align">
										...
										<p class="no-margin">Transfer In</p>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card gradient-45deg-red-pink gradient-shadow min-height-100 white-text">
								<div class="padding-4">
									...
									<div class="col s8 m8 right-align">
										...
										<p class="no-margin">Transfer Out</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row" style="width: 100%; margin-bottom: 0px;">
					<div class="col s12">
						<div class="card" style="width: 100%; height: 430px; padding:6px">
							<h5 class="center" style="font-size:14px; font-weight:bold; margin:0;">Distribution of personnel by Dept, Units and Divisions</h5>
							<div style="width: 100%;">
